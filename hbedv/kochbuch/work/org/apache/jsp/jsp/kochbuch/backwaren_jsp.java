...
public final class backwaren_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (client.getBsWidth().intValue() < 1152) {
	...
	topZub = -6;
      ...
      out.write("\ts1z1.style.width = '70%';\r\n");
      out.write("\t\r\n");
      out.write("\tvar s2z1 = document.getElementById('s2z1');\r\n");
      out.write("\ts2z1.style.width = '30%';\r\n");
      out.write("\t\r\n");
      ...
      out.write("\tif (e > 415) div1.style.width = e + \"px\";\r\n");
      out.write("\tif (e <= 415) div1.style.width = \"415px\";\r\n");
      out.write("\t\r\n");
      ...
      out.write("\tif (e > 415) rezTd01.style.width = e + 'px';\r\n");
      out.write("\tif (e <= 415) rezTd01.style.width = '415px';\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\t<td id=\"s1z1\" style=\"text-align:left;height:35px;\">\r\n");
      out.write("\t\t\t<em>\r\n");
      out.write("\t\t\t\t<strong>\r\n");
      out.write("\t\t\t\t\t<font face=\"Sylfaen\" style=\"font-size:175%\">\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<div id=\"div4\" style=\"border-color:#D9B565; border-width:1px;border-style:solid;padding:0px;overflow:auto; width:200px;position:relative;left:4px;\">\r\n");
      out.write("\t\t\t\t\t\t\t<img id=\"pic1\" src=\"");
      out.print(manager.getPicName());
      out.write("\" width=\"200px\" height=\"156px\" ALT=\"\"");
      out.print(manager.getRezeptNameJSP());
      out.write(" style=\"position:relative;left:0px;top:0px\" >\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
