...
if (client.getMessage() != null && !client.getMessage().equals("")) { 
	...
	client.setMessage("");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"rezeptname\" maxlength=\"50\" value=\"");
      out.print(manager.getRezeptName());
      out.write("\" style=\"width:70%;font-size:24px;\" class=\"kbedit\" >\r\n");
      out.write("\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t</strong>\r\n");
      out.write("\t\t\t\t</em>\r\n");
      out.write("\t\t\t</p>\r\n");
...
AliceSortMap zutatenListe = manager.getZutaten();
	...
	for (int index=startJS;index<100;index++) {
      ...
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td valign=\"top\" style=\"position:absolute;top:12px\">\r\n");
      out.write("\t\t\t");
      out.write("<script language=\"JavaScript\" type=\"text/JavaScript\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
