...
<% 
	...
	String auswahlErr = "Rezeptart auswaehlen!";
%>
...
<table id="table01" width="100%" border="0" >
				...
				<em>
					<strong>
						<font size="5" face="Sylfaen" >
							<input type="text" name="rezeptname" maxlength="50" value="<%=manager.getRezeptName()%>" style="width:70%;font-size:24px;" class="kbedit" >
						</font>
					</strong>
				</em>
			</p>
	...
	<tr>
		...
		<td valign="top" style="position:absolute;top:12px">
